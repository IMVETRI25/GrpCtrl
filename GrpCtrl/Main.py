...
from GrpCtrl import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, OWNER_NAME, ALLOW_EXCL, client
from GrpCtrl.modules import ALL_MODULES
from GrpCtrl.modules.helper_funcs.chat_status import is_user_admin
from GrpCtrl.modules.helper_funcs.misc import paginate_modules
from GrpCtrl.modules.connection import connected
from GrpCtrl.modules.connection import connect_button
...
HELP_STRINGS = """
Hello There! IM *{}*.
I'm control your group to avoiding traders, spammers, 🔞!  

here to help you get around and keep the order in your groups!

Press /help to continue...

*My commanads available On*:
 👽 - /start: start the bot
 👽 - /help: PM's you this message.
 👽 - /help <module name>: PM's you info about that module.
 👽 - /source: Information about my source.
 👽 - /settings:
   ♦️ - in PM: __will send you your settings for all supported modules.__
   ♦️ - in a group: __will redirect you to pm, with all that chat's settings.__
{}
*And the following*:
...
✨ You Can Clone Me [Here](https://heroku.com/deploy?template=https://github.com/IMVETRI25/GrpCtrlBot.git)
"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("GrpCtrl.modules." + module_name)
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="☠Help☠",callback_data="help_back"),InlineKeyboardButton(text="👻Creator👻",url="https://t.me/IMVETRI")]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="☠Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="👻Contact Creator",url="https://t.me/IMVETRI")]]))
        return
