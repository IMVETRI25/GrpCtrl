...
import GrpCtrl.modules.sql.global_bans_sql as sql

from GrpCtrl import dispatcher, OWNER_ID, DEV_USERS, SUDO_USERS, SUPPORT_USERS, WHITELIST_USERS, GBAN_LOGS, STRICT_GBAN, spam_watch

from GrpCtrl.modules.helper_funcs.chat_status import user_admin, is_user_admin

from GrpCtrl.modules.helper_funcs.extraction import extract_user, extract_user_and_text

from GrpCtrl.modules.helper_funcs.filters import CustomFilters

from GrpCtrl.modules.helper_funcs.misc import send_to_list

from GrpCtrl.modules.sql.users_sql import get_all_chats
...
def gban(bot: Bot, update: Update, args: List[str]):
    ...
    message.reply_text("⚡️ *Successfully Gbanned* ⚡️")
